...
def main() -> int:
    ...
    if upstream != "0.4.2":
        parser.error(f"VERSION must be 0.4.1, found {upstream!r}")
    ...
    if not args.skip_tests:
        ...
        for test in ("test_collector.py", "test_reporting_guardrails.py", "test_network_context.py", "test_v040.py", "test_v041.py", "test_v042.py", "test_packaging.py"):
